% Inputs the parameters and then runs the Model, then outputs the cell
% tracks.
close all; clear;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Diffusion Constant
...
% Call the function ResultCellTracks to output the simulation's cell
% paths to a figure.
ResultCellTracks(ymax, cellPosition, cellRadius);
